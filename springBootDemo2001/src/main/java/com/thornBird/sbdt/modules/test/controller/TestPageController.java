...
public class TestPageController {
	...
	public String testIndexPage(ModelMap modelMap){
		...
		int countryId = 522;
		Country country = countryService.getCountryByConutryId(countryId);
